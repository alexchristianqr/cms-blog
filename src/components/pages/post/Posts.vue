                    ...
                    <div class="card-header border-secondary bg-light">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <router-link :to="{name:'post-create'}" class="btn btn-outline-primary">Create Post</router-link>
                            </div>
                        </div>
                        <hr>
                                ...
                                <tr v-for="(post,k) in filteredPosts">
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Button group with nested dropdown">
                                            <router-link :to="{name:'post-update',params:{dataPost:post}}" class="btn btn-light border-secondary btn-sm">
                                            ...
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="btnGroupDrop1">
                                                    <a class="dropdown-item text-danger" href="#"><i class="fa fa-trash-o fa-fw"></i>Delete</a>
                                                    <a class="dropdown-item text-success" href="#"><i class="fa fa-refresh fa-fw"></i>Change Status</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
