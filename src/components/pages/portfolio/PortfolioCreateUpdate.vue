  ...
  <div class="card border-secondary">
    <form @submit.prevent="createOrUpdate">
      <div class="card-header border-secondary bg-light">
        <div class="row">
          ...
          <div class="col-6 text-right">
            <router-link :to="{name:'portfolios'}" class="btn btn-light"><i class="fa fa-angle-left fa-fw"></i>Back
            </router-link>
      ...
      <div class="card-body" :style="loading ? 'opacity:0.5; z-index:123456 !important;' : ''">
        ...
        <errors-laravel v-show="Object.keys(dataErrors).length > 0" :data-errors="dataErrors"
                        @eventClose="dataErrors = {}"/>
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-2">
            ...
            <input v-model="params.repository_github" type="text" class="form-control"
                   placeholder="Repository in Github">
            <template v-if="params.repository_github">
              <div class="input-group-append">
                <button class="btn btn-danger" @click.prevent="params.repository_github=''"><i class="fa fa-times"></i>
                </button>
              </div>
            </template>
          </div>
          <div class="input-group mb-2">
            ...
            <input v-model="params.repository_codepen" type="text" class="form-control"
                   placeholder="Repository in Codepen">
            <template v-if="params.repository_codepen">
              <div class="input-group-append">
                <button class="btn btn-danger" @click.prevent="params.repository_codepen=''"><i class="fa fa-times"></i>
                </button>
              </div>
            </template>
          </div>
